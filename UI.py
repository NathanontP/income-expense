...
def view_report_ui():
    ...
    tk.Button(selector, text="ดูรายงาน", command=on_select).pack(pady=10)
...
def edit_report_ui():
    ...
    def open_report_editor(report_file):
        ...
        def update_selected():
            ...
            tk.Label(update_win, text="ประเภท:").pack()
            type_var = tk.StringVar(value=values[0])
            type_menu = ttk.Combobox(update_win, textvariable=type_var, values=["รายรับ", "รายจ่าย"], state="readonly")
            type_menu.pack()

            tk.Label(update_win, text="หมวดหมู่:").pack()
            category_var = tk.StringVar(value=values[1])
            tk.Entry(update_win, textvariable=category_var).pack()

            tk.Label(update_win, text="รายละเอียด:").pack()
            detail_var = tk.StringVar(value=values[2])
            tk.Entry(update_win, textvariable=detail_var).pack()

            tk.Label(update_win, text="จำนวนเงิน:").pack()
            amount_var = tk.StringVar(value=values[3])
            tk.Entry(update_win, textvariable=amount_var).pack()
            ...
            tk.Button(update_win, text="บันทึก", command=save_changes).pack(pady=10)
        ...
        def add_new_entry():
            ...
            tk.Label(add_win, text="ประเภท:").pack()
            type_var = tk.StringVar(value="รายรับ")
            type_menu = ttk.Combobox(add_win, textvariable=type_var, values=["รายรับ", "รายจ่าย"], state="readonly")
            type_menu.pack()

            tk.Label(add_win, text="หมวดหมู่:").pack()
            category_var = tk.StringVar()
            tk.Entry(add_win, textvariable=category_var).pack()

            tk.Label(add_win, text="รายละเอียด:").pack()
            detail_var = tk.StringVar()
            tk.Entry(add_win, textvariable=detail_var).pack()

            tk.Label(add_win, text="จำนวนเงิน:").pack()
            amount_var = tk.StringVar()
            tk.Entry(add_win, textvariable=amount_var).pack()
            ...
            tk.Button(add_win, text="เพิ่ม", command=add_to_data).pack(pady=10)
        ...
        tk.Entry(win, textvariable=search_var).pack(fill="x", padx=10)
        ...
        tk.Button(btn_frame, text="เพิ่มรายการใหม่", command=add_new_entry).grid(row=0, column=0, padx=5)
        tk.Button(btn_frame, text="ลบรายการที่เลือก", command=delete_selected).grid(row=0, column=1, padx=5)
        tk.Button(btn_frame, text="แก้ไขรายการที่เลือก", command=update_selected).grid(row=0, column=2, padx=5)
        tk.Button(win, text="บันทึกการเปลี่ยนแปลง", command=save_changes_to_file).pack(pady=10)
    ...
    tk.Button(selector, text="ตกลง", command=on_select).pack(pady=10)
